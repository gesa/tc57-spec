...
\p Variable declarations with program storage duration in the cbuffer
declaration are called \textit{shader constants}. Shader constants are implicitly
const-qualified and cannot be modified in program code.
